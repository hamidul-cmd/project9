    ...
    <>
      ...
      <section className="px-4 xll:px-10 3xl:px-12.5 mb-12.5 xll:mb-20 3xl:mb-24.7">
        <div className="wrapper__div">
          ...
          <a href="/" className="mt-2.5 py-5 bg-dark-10 rounded-xl flex justify-center items-center font-roboto__mono md:hidden">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-sm font-medium leading-150 uppercase text-gray-70">ALL Testimonials</span>
            </div>
          </a>
        </div>
      </section>
